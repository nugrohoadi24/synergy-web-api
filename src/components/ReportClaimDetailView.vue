<template>
  <b-row class="vh-100 text-center" align-v="center" align-h="center">   
    ...
    <b-row>
      <b-col>
        <center>
        <b-card title="REPORT DETAIL CLAIM" sub-title="SILAHKAN ISI PARAMETER REPORT" 
  ...
  export default {
    ...
    methods: {
      ...
      async openReport () {
        ...
        window.open(process.env.API_BASE_URL + "/report/claim/" + encodeURIComponent(this.company_policy) + "?token=" + accessToken , '_blank');
      }
    }
  }
</script>
