  ...
  export default {
    ...
    methods: {
      async loadItems(page){   
        ...
        this.$emit('loadItems', this.productType, page, this.sortBy, this.sortDesc, this.tableData.limit, this.search);
      },

      async reloadItems(){   
          if(!Boolean(this.sortBy))
            this.sortBy = 'created_at'          
          this.$emit('loadItems', this.productType, this.tableData.page, this.sortBy, this.sortDesc, this.tableData.limit, this.search);
      },
